...
const AttachedFileDropdown = (props) => {
  return (
    <div>
      <Menu as='div' className='relative inline-block text-left -mt-1'>
        ...
        >
          <Menu.Items className='absolute right-0 top-8 p-3 w-40 z-10 rounded bg-slate-600 shadow-lg border-2 border-slate-500'>
...
export default AttachedFileDropdown;
